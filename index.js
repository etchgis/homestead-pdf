...
(async () => {
  ...
  try {
    const data = process.env.DEV ? JSON.parse(fs.readFileSync(path.join(__dirname, "lib/sampleData.json"))) : JSON.parse(JSON.parse(fs.readFileSync(`c:/inetpub/internal/homestead-admin/applications/${id}.json`)));
